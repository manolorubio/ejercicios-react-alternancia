/**
 * Contacto.jsx
 * Ejercicio 1 — Sección Contacto
 * Contiene el componente ContactForm (Ejercicio 2).
 */
...
const contactInfo = [
  { icon: '📍', label: 'Dirección',  value: 'España, IES Ejemplo' },
  { icon: '📧', label: 'Email',      value: 'julian@ejemplo.com' },
...
function Contacto() {
  return (
    <div className="contacto-page page">

      {/* Cabecera */}
      <header className="contacto-header">
        <span className="section-tag">✉️ Contacto</span>
      ...
      <div className="contacto-layout">
        ...
        <aside className="contacto-info">
          <div className="contacto-info-card card">
            <h2 className="info-title">Información de contacto</h2>
            <p className="info-subtitle">
              Estamos aquí para ayudarte con cualquier pregunta sobre el proyecto.
            </p>
        ...
        {/* Columna derecha: formulario (Ejercicio 2) */}
